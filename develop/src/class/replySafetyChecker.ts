...
export class ReplySafetyChecker {
  private static COOL_TIME_DUR_SEC = 60; // リプライクールタイム（秒）
  private lastReplyTimePerPubkey = new Map<string, number>(); // 公開鍵ごとの最後のリプライ時刻を保持するMap
   ...
   */
  public isSafeToReply(event: Event): boolean {
